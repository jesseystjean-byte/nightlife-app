...
export const s = StyleSheet.create({
  ...
  swipeBtn: { width:58, height:58, borderRadius:29, alignItems:'center', justifyContent:'center', borderWidth:1.5, borderColor: LINE },
  swipeNo: { backgroundColor: CARD, borderColor:'rgba(255,107,107,0.55)' },
  swipeYes: { backgroundColor: CARD, borderColor:'rgba(217,255,61,0.6)' },
  swipeBtnIcon: { fontSize:24 },
