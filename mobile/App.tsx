...
const s = StyleSheet.create({
  ...
  brand:{color: ACCENT, fontSize:42, fontWeight:'900', letterSpacing:-1, marginTop:20},
  brandSm:{color: FG, fontSize:22, fontWeight:'800', letterSpacing:-0.5},
  h1:{color: FG, fontSize:28, fontWeight:'800', marginVertical:10, letterSpacing:-0.4},
  h2:{color: FG, fontSize:20, fontWeight:'700'},
  pBig:{color: FG, fontSize:16, lineHeight:23, marginTop:8},
  pSm:{color: MUTED, fontSize:13, lineHeight:18},
  label:{color: FG, fontSize:14, fontWeight:'600', marginBottom:8},
  hint:{color: MUTED, fontSize:12, marginTop:6},
  input:{backgroundColor: CARD, color: FG, paddingHorizontal:14, paddingVertical:12, borderRadius:12, fontSize:16, borderWidth:1, borderColor: LINE},
  row:{flexDirection:'row', alignItems:'center'},
  rowSb:{flexDirection:'row', alignItems:'center', justifyContent:'space-between', marginBottom:18},
  wrap:{flexDirection:'row', flexWrap:'wrap', gap:8},
  chip:{backgroundColor: CARD, paddingHorizontal:14, paddingVertical:10, borderRadius:999, borderWidth:1, borderColor: LINE, marginRight:8, marginBottom:8},
  chipSm:{paddingHorizontal:12, paddingVertical:7},
  chipOn:{backgroundColor: ACCENT, borderColor: ACCENT},
  chipTxt:{color: FG, fontSize:14, fontWeight:'600'},
  chipTxtSm:{fontSize:13},
  chipTxtOn:{color:'#000'},
  btn:{backgroundColor: ACCENT, paddingHorizontal:24, paddingVertical:14, borderRadius:999, alignItems:'center', minWidth:160},
  btnDis:{opacity:0.35},
  btnTxt:{color:'#000', fontSize:16, fontWeight:'800'},
  ghost:{paddingHorizontal:20, paddingVertical:14},
  ghostTxt:{color: MUTED, fontSize:15, fontWeight:'600'},
  progT:{height:4, backgroundColor: LINE, borderRadius:2, marginTop:10, overflow:'hidden'},
  progF:{height:4, backgroundColor: ACCENT},
  obHeader:{paddingHorizontal:20, paddingTop:10, paddingBottom:14, borderBottomWidth:1, borderColor: LINE},
  stepCount:{color: MUTED, fontSize:12, fontWeight:'600'},
  obBody:{padding:20, paddingBottom:40},
  obFooter:{flexDirection:'row', alignItems:'center', justifyContent:'space-between', padding:18, borderTopWidth:1, borderColor: LINE},
  topBar:{flexDirection:'row', alignItems:'center', justifyContent:'space-between', paddingHorizontal:18, paddingVertical:14},
  avatar:{width:36, height:36, borderRadius:18, backgroundColor: CARD, borderWidth:1, borderColor: LINE, alignItems:'center', justifyContent:'center'},
  avatarTxt:{color: ACCENT, fontWeight:'800'},
  searchRow:{flexDirection:'row', paddingHorizontal:14, paddingBottom:10, gap:8},
  searchBox:{flex:1, backgroundColor: CARD, borderRadius:14, paddingHorizontal:14, borderWidth:1, borderColor: LINE},
  searchInput:{color: FG, fontSize:15, height:46},
  townieBtn:{backgroundColor: ACCENT, paddingHorizontal:18, borderRadius:14, alignItems:'center', justifyContent:'center'},
  townieBtnTxt:{color:'#000', fontWeight:'800', fontSize:14},
  summary:{color: MUTED, fontSize:13, paddingHorizontal:18, paddingBottom:8, fontStyle:'italic'},
  emptyTitle:{color: FG, fontSize:18, fontWeight:'700', marginBottom:6},
  ...
  cardBody:{padding:14},
  tag:{backgroundColor:'#1f1f27', paddingHorizontal:8, paddingVertical:3, borderRadius:6},
  tagTxt:{color: MUTED, fontSize:11, fontWeight:'600', textTransform:'uppercase'},
  cardTitle:{color: FG, fontSize:17, fontWeight:'800', marginTop:8, lineHeight:22},
  cardMeta:{color: MUTED, fontSize:13, marginTop:4},
  cardDesc:{color:'#bbb', fontSize:13, marginTop:8, lineHeight:18},
  actSm:{paddingHorizontal:14, paddingVertical:8, borderRadius:999, backgroundColor:'#222', alignItems:'center'},
  actDetailsTxt:{color: FG, fontSize:13, fontWeight:'700'},
  tabBar:{flexDirection:'row', borderTopWidth:1, borderColor: LINE, backgroundColor: BG, paddingVertical:10, paddingBottom:Platform.OS==='ios'?28:14, position:'absolute', left:0, right:0, bottom:0},
  tabItem:{flex:1, alignItems:'center', paddingVertical:6},
  tabLabel:{color: MUTED, fontSize:13, fontWeight:'700'},
  detailTitle:{color: FG, fontSize:24, fontWeight:'800', lineHeight:30},
  detailMeta:{color: MUTED, fontSize:14, marginTop:6},
  detailDesc:{color: FG, fontSize:15, lineHeight:22, marginTop:14},
  detailFooter:{flexDirection:'row', alignItems:'center', justifyContent:'space-between', padding:18, borderTopWidth:1, borderColor: LINE},
});
import React, { useEffect, useMemo, useState } from 'react';
import { SafeAreaView, View, Text, TextInput, TouchableOpacity, ScrollView, FlatList, Image, ActivityIndicator, StyleSheet, Modal, Platform, KeyboardAvoidingView, Switch } from 'react-native';
import AsyncStorage from '@react-native-async-storage/async-storage';
